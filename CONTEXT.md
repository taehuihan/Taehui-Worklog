...
| 프로덕트 | 폴더 | 현재 상태 | 다음 |
|----------|------|-----------|------|
| **VestWay** | [vestway/](vestway/) | master-flow v3(16245:20440)·내정보(16297:15585)·**챌린지 모바일(16374:19659, 내정보 우측)** 처음부터 재빌드. 가이드 SSOT에 작업순서 가드(0단계 트리거맵·§2 포인터·9단계 검증)·출발점 고정 모델·레인 클리어런스. git/메모리 동기화 완료(06-23) | v3 DEPTH_GAP 800, 챌린지 홈→안내 표기, 9단계 검증 스크립트화 |
