...
## ⭐ 현행 모델 (v3, 2026-06-23 갱신) — 이 섹션이 최신·우선
...
- 출발: 트리거 컴포넌트 우측 height center / 도착: ARROW_EQUILATERAL
- 화면 통과 금지 (OVER 우회 / midX 분리)
- ~~`firstBend ≥ screen_right+10`~~ **삭제** (뎁스 간만이라 공간 충분)
...
- 후보 필터: INSTANCE/COMPONENT 또는 이름 button/cta/icon (텍스트·배경 제외)
