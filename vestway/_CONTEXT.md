...
| Master 플로우 다이어그램 | [master-flow/](master-flow/) | **v3 `16245:20440`**(V.AI) + **내정보 `16297:15585`** + **챌린지 모바일 `16374:19659`**(내정보 우측 x47836, 처음부터 재빌드 06-23, 32화면·참여 1행·9단계 검증통과). 가이드 SSOT(16097:3930)에 **작업순서 가드**(0단계 트리거 맵·4·5·6 §2 포인터·9단계 수치검증)·**출발점 고정 모델**·**레인 전구간 클리어런스** 반영. guide.md·메모리 동기화 완료(06-23) | v3 DEPTH_GAP 800 재배치 여부, 챌린지 홈→안내 표기, 9단계 검증 스크립트 내장 |
