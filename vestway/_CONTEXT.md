...
> Last updated: 2026-06-26 (블룸버그 기억리셋 재빌드 `16503:28646` — 기준섹션 모델로 전면 재구성: 서브레이블=뎁스별·무료유료=상태레이블. 「다른 화면=분기행」+「레이블 모델」 가드 반영)
